...
class MetricCard extends StatelessWidget {
  ...
  Color _toneBorderColor() {
    switch (tone) {
      case MetricTone.green:
        return ReLoopColors.brand500;
      case MetricTone.amber:
        return ReLoopColors.statusFull;
      case MetricTone.blue:
        return ReLoopColors.info;
      case MetricTone.teal:
        return ReLoopColors.accent;
      case MetricTone.slate:
        return ReLoopColors.neutral;
    }
  }
  ...
  Color _toneColor(BuildContext context) {
    switch (tone) {
      ...
      case MetricTone.amber:
        return context.isDarkMode
            ? const Color(0xFFF5B85C)
            : const Color(0xFFB45309);
      case MetricTone.blue:
        return context.isDarkMode
            ? const Color(0xFF77AFFF)
            : const Color(0xFF1D4ED8);
      case MetricTone.teal:
        return context.isDarkMode
            ? const Color(0xFF63D6CC)
  ...
  Color _toneValueColor(BuildContext context) {
    switch (tone) {
      ...
      case MetricTone.blue:
        return context.isDarkMode
            ? const Color(0xFF8BBCFF)
            : const Color(0xFF1E40AF);
      case MetricTone.teal:
        return context.isDarkMode
            ? const Color(0xFF70DDD2)
