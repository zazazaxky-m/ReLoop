...
class StatusBadge extends StatelessWidget {
  ...
  static const _registry = <String, _StatusEntry>{
    ...
    'PENDING_SUPERADMIN_APPROVAL': _StatusEntry(
      'Menunggu Approval',
      BadgeTone.warning,
      Icons.schedule,
    ),
    'SUSPENDED': _StatusEntry(
      'Ditangguhkan',
      BadgeTone.warning,
      Icons.warning_amber_rounded,
    ),
    ...
    'PICKUP_REQUESTED': _StatusEntry(
      'Pickup Diminta',
      BadgeTone.info,
      Icons.local_shipping,
    ),
    'PENDING_REWARD': _StatusEntry(
      'Reward Pending',
      BadgeTone.warning,
      Icons.schedule,
    ),
  ...
  Widget build(BuildContext context) {
    ...
    return ReLoopBadge(label: entry.label, tone: entry.tone, icon: entry.icon);
  }
